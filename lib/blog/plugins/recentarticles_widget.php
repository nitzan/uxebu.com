...
// eiger Code Start
	echo '<li class="widget widget-recentarticlesuxebustyle"><div class="hd"><div class="col-6"><h3 class="widgettitle">Recent</h3></div><div class="col-6 last"><a class="viewall" href="' . get_option('home') . '/archive/" title="View all posts">View all posts...</a></div></div><hr class="widget-hr" /><div class="bd"><ul>';
